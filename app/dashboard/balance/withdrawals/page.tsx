...
const FAKE_BANKS = ['Chase Bank', 'Bank of America', 'Wells Fargo', 'Citibank', 'US Bank'];
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                            ...
                            <p className="text-[12px] text-[#5a7568]">
                                Funds will arrive in your bank account within{' '}
            ...
            <div className="bg-white border border-[#dde8e3] rounded-[16px] overflow-hidden">
                <div className="grid grid-cols-5 px-4 py-3 border-b border-[#f0f5f2] bg-[#f6faf8]">
                    {['Date & Time', 'Bank', 'Reference', 'Amount', 'Status'].map((h) => (
                        <p
                            key={h}
                            className="text-[10px] font-semibold text-[#8a9e96] tracking-wide uppercase"
                        >
                            {h}
                        </p>
                    ))}
                ...
                {!loading && error && (
                    <div className="flex flex-col items-center justify-center py-12 gap-2">
                        ...
                        <button
                            onClick={handleSearch}
                            className="cursor-pointer text-[12px] text-[#1d9e75] underline"
                        >
                            Try again
                        </button>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-12 gap-3">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-[12px] text-[#8a9e96] mt-0.5">
                                Click "Withdraw Now" to transfer funds
                            </p>
                        </div>
                    </div>
                )}
                        ...
                        <div className="px-6 py-5 overflow-y-auto max-h-[75vh]">
                            ...
                            <div className="flex items-start gap-2.5 bg-[#FAEEDA]/50 border border-[#f5d9a8] rounded-[10px] px-3.5 py-3 mb-4">
                                ...
                                <p className="text-[12px] text-[#633806]">
                                    Funds will be deducted immediately. Bank transfer takes{' '}
                                    <span className="font-semibold">1–3 business days</span>.
                                </p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                                ...
                                >
                                    <div className="relative">
                                        <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[13px] font-semibold text-[#8a9e96]">
                                            $
                                        </span>
                                        <input
                                            {...register('amount')}
                                    ...
                                    {watchedAmount && Number(watchedAmount) > 0 && (
                                        <p className="text-[11px] text-[#633806] font-medium">
                                            {formatUSD(Number(watchedAmount))} will be deducted from
                                            your balance
                                        </p>
                                    )}
                                </Field>
